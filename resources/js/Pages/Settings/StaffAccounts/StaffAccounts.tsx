  ...
  const handleAddSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (newStaff.id) {
          window.location.href = `/settings/staff/${newStaff.id}/edit`;
        } else {
          console.error("New staff ID is missing");
        }
      } else {
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-6 p-8">
          <h1 className="text-3xl font-semibold">Settings: Staff Accounts</h1>
