...
export default function Collections({ jobs = [], collection_types, sanitisation_options, pagination }: Props) {
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-6 p-8">
          <div className="text-3xl font-semibold text-gray-800">Collections</div>
