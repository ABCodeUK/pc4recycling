...
export default function Quotes({ jobs, customers, collection_types, sanitisation_options, status_options, }: Props) {
  ...
  const [addFormData, setAddFormData] = useState({
    ...
    client_id: '',
    collection_date: '',
    job_status: 'Quote Requested', // Changed from 'Needs Scheduling' to 'Quote Requested'
    staff_collecting: '',
    vehicle: '',
    address: '',
    town_city: '',
  ...
  useEffect(() => {
    const fetchNextJobId = async () => {
      try {
        const response = await axios.get('/quotes/next-job-id');
  ...
  const handleAddSubmit = async () => {
      ...
      try {
          ...
          const response = await axios.post('/quotes', formattedData, {
              headers: {
        ...
        return (
          <div className="flex justify-end space-x-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => window.location.href = `/quotes/${job.id}/`}
            >
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-6 p-8">
          <div className="text-3xl font-semibold text-gray-800">Jobs: Quotes</div>
                ...
                <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[425px] bg-white">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Fill in the basic details for the new quote. You can add more details after creation.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            {status_options
                              .filter(status => ['Quote Requested'].includes(status))
                              .map((status) => (
