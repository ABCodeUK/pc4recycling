...
// Update the event rendering in MonthView to make it clickable
const EventItem = ({ event, onClick }: { event: CalendarEvent; onClick?: (event: CalendarEvent) => void }) => (
  <div
    key={event.id}
...
// Update CalendarNextTrigger
const CalendarNextTrigger = forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(
...
// Update CalendarPrevTrigger
const CalendarPrevTrigger = forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(
  ({ children, onClick, ...props }, ref) => {
    const { date, setDate, view, enableHotkeys } = useCalendar();
